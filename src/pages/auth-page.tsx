        ...
        <div className="form-group">
          <div className="form-item">
                ...
                endAdornment: (
                  <InputAdornment position="end">
                    <AppIcon style={{
                      ...
                      name={`${showPassword ? "VisibilityOffOutlined" : "VisibilityOutlined"}`} color="success"
                    />
                  </InputAdornment>
                ),
              }}
            ...
            <div className="submit-section">
              ...
              <AppLink id="register" data-speciallink label="don't have an account ? register"/>
            </div>
          </div>
        </div>
      </form>
        ...
        <div className="form-group">
          <div className="form-item">
            ...
            <div className="submit-section">
              ...
              <AppLink id="login" data-speciallink label="already have an account ? login"/>
            </div>
          </div>
        </div>
      </form>
